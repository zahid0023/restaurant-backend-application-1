...
Each menu item has at most one recipe (one-to-one). Recipes are nested under a menu item. All path parameters must refer to existing active resources.

---

### Create Recipe

**`POST /api/v1/menus/{menu-id}/sections/{section-id}/items/{item-id}/recipes`**
...
**`GET /api/v1/menus/{menu-id}/sections/{section-id}/items/{item-id}/recipes/{id}`**
...
Returns a paginated list of all active recipes for a given menu item.

**`GET /api/v1/menus/{menu-id}/sections/{section-id}/items/{item-id}/recipes`**
...
**`PUT /api/v1/menus/{menu-id}/sections/{section-id}/items/{item-id}/recipes/{id}`**
...
Soft-deletes a recipe (sets `is_active = false`, `is_deleted = true`).

**`DELETE /api/v1/menus/{menu-id}/sections/{section-id}/items/{item-id}/recipes/{id}`**
...
Ingredient lines of a recipe. Each recipe item links an inventory item with an optional quantity. All path parameters must refer to existing active resources.
