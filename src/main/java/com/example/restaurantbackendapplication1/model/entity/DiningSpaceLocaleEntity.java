...
@Setter
@Entity
@Table(name = "dining_space_locales")
public class DiningSpaceLocaleEntity extends AuditableEntity {
    @NotNull
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @OnDelete(action = OnDeleteAction.CASCADE)
    @JoinColumn(name = "dining_space_id", nullable = false)
    private DiningSpaceEntity diningSpaceEntity;
