...
@Setter
@Entity
@Table(name = "inventory_location_locales")
public class InventoryLocationLocaleEntity extends AuditableEntity {

    @NotNull
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @OnDelete(action = OnDeleteAction.CASCADE)
    @JoinColumn(name = "inventory_location_id", nullable = false)
